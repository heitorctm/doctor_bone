...
'''
destaca os canais mais relevantes

argumentos:
    - input_feature: tensor de entrada
    - ratio: fator de reducao para o numero de filtros (default: 8)
retorna:
    - tensor com atencao de canal aplicada
'''
...
'''
destaca areas mais relevantes na imagem

argumentos:
    - input_feature: tensor de entrada
retorna:
    - tensor com atencao espacial aplicada
'''
...
o bloco CBAM aplica atencao de canal e atencao espacial sequencialmente para destacar as caracteristicas mais relevantes
argumentos:
    - cbam_feature: tensor de entrada
    - ratio: fator de reducao para o numero de filtros (default: 8)
retorna:
    - tensor com atencao de canal e espacial aplicadas
'''
...
recalibra os filtros do tensor de entrada, destacando os mais importantes

argumentos:
    - input_tensor: tensor de entrada
    - ratio: fator de reducao para o numero de filtros (default: 16)
retorna:
    - tensor com atencao squeeze-and-excitation aplicada
'''
